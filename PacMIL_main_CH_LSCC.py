...
#### PacMIL: An End-to-end Multi-instance Learning Network via Prior-instance Adversarial Contrastive for Larynx Pathology Grading
...
if __name__ == '__main__':
    ...
    paras.add_argument('--gpu_device', type=int, default=3)
    ...
    paras.add_argument('--train_read_path', type=str,
                default=r'/media/ps/e7ca49a0-dd37-483e-8750-c97d354e6c73/PacMIL/Datasets/Larynx/CH_LSCC/Train')
    paras.add_argument('--test_read_path', type=str,
                default=r'/media/ps/e7ca49a0-dd37-483e-8750-c97d354e6c73/PacMIL/Datasets/Larynx/CH_LSCC/Test')
    paras.add_argument('--val_read_path', type=str,
                default=r'/media/ps/e7ca49a0-dd37-483e-8750-c97d354e6c73/PacMIL/Datasets/Larynx/CH_LSCC/Val')
    ...
    paras.add_argument('--weights_save_path', type=str,
            default=r'/media/ps/e7ca49a0-dd37-483e-8750-c97d354e6c73/PacMIL/Results_weight_text/Larynx/PacMIL_CH_LSCC.pth')
    ###
    ...
    paras.add_argument('--test_weights_feature', type=str,
                       default=r'D:\PacMIL\Results_weight_text\Larynx\Larynx_May_Ablation.pth')
    ...
    if args.data_parallel == False:
        ...
        pacmil_net = PacMIL(base_model=swinT_base, class_num=args.class_num, final_avp_kernel_size=9, final_avp_tride=9,
                            pac_token_shape=args.bags_len, pac_project_scale=2, pac_pool_size=(9, 768), pac_lamda=0.1)
        #pacmil_net = PacMIL_for_ablation(base_model=swinT_base, class_num=args.class_num)
        with torch.no_grad():
            print('########################## PacMIL_summary #########################')
            #summary(stivit_net, (3, 96, 96), device='cpu')
            print('\n', '########################## PacMIL #########################')
            print(pacmil_net, '\n')
        ...
        with torch.no_grad():
            print('########################## PacMIL_summary #########################')
            #summary(stivit_feature, (3, 96, 96), device='cpu')
            #summary(stivit_head, (2, 768), device='cpu')
            print('\n', '########################## DHM_MILNet #########################')
